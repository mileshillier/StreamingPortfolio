...
export const TITLES: Title[] = [
  ...
  define({
    ...
    tagline: 'One source of truth for forty product teams.',
    category: 'product',
    ...
    description:
      'Forty teams, six button styles, and zero consistency. Atlas follows the creation of a design system that engineers actually wanted to adopt.',
    team: ['Miles Hillier', 'Lena Park', 'Chris Adeyemi', 'Noor Haddad'],
    ...
    outcomes: [
      ...
      { value: '340', label: 'Tokens shipped' },
    ],
    imageSeed: 'atlas-grid',
    accent: '#8b5cf6',
    logo: { font: "'Syne', sans-serif", weight: 800, uppercase: true, letterSpacing: '0.12em' },
